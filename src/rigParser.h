...
typedef struct
{
	...
	uint8_t *expression_pool;

} rig_t;


// define the size of the largest possible rig
// there will space for at least TWO of these statically
// allocated, and one will be allocated on the heap
// during parsing.
